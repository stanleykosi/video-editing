...
`transcripts/movie recap.txt` so agents do not default to long raw scene runs or
...
- Recap narration must go through `content_creation/script_subagent_review_loop.md`:
