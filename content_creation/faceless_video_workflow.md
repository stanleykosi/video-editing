...
- Story: `skills/editing_taste_story_pacing.md`
- Retention: `skills/short_form_retention.md`
- Visuals: `skills/motion_graphics.md`
- Typography/captions: `skills/video_typography.md`,
  `skills/kinetic_captions.md`
- Sound: `skills/sound_design.md`, `skills/beat_sync.md`
- Color: `skills/color_grading.md`
- QC: `skills/editor_qc.md`
- Assets: `sources/asset_resource_platforms.md`,
  `qc_checklists/asset_manifest_qc.md`
