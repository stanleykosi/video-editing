...
- `content_creation/templates/script_brief_template.md`
- `content_creation/templates/script_critique_template.md`
- `content_creation/templates/script_revision_log_template.md`
...
- `skills/short_form_retention.md` when retention matters
- `content_creation/youtube_storytelling_workflow.md` for story-led videos
- `skills/movie_recap_workflow.md` for movie/anime/episode recaps
