...
`knowledge/workflows/content_creation/templates/script_template.md`.

Do not write `script.md` directly from a single main-agent pass. First run the
subagent writer/critic workflow in `knowledge/workflows/content_creation/script_subagent_review_loop.md`.
...
- `knowledge/playbooks/viral_youtube_editing_workflow.md`
