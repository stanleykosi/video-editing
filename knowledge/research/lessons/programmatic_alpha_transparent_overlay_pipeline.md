...
- Tutorials/docs:
  - `knowledge/research/source_notes/remotion_transparent_videos_source_notes.md`
  - `knowledge/research/source_notes/remotion_creating_overlays_source_notes.md`
  - `knowledge/research/source_notes/remotion_offthreadvideo_transparent_source_notes.md`
  - `knowledge/research/source_notes/curio_ffmpeg_alpha_masking_source_notes.md`
  - `knowledge/research/source_notes/hhsprings_ffmpeg_alphamerge_alphaextract_source_notes.md`
  - `knowledge/research/source_notes/hhsprings_ffmpeg_alphamerge_alphaextract_more_source_notes.md`
  - `knowledge/research/source_notes/ffmpeg_filters_alpha_masking_official_source_notes.md`
  - `knowledge/research/source_notes/ffmpeg_wipe_reveal_alpha_mask_source_notes.md`
  - `knowledge/research/source_notes/mdn_css_masking_source_notes.md`
- Related cards:
